...
STR = {
    ...
    "section_liquidity_daily": {"tr": "LİKİDİTE", "en": "Liquidity"},
    ...
    "card_fed_balance_sheet": {"tr": "FED BİLANÇOSU", "en": "FED BALANCE SHEET"},
    "card_m2": {"tr": "ABD M2 PARA ARZI", "en": "US M2 MONEY SUPPLY"},
    "card_stablecoin_supply": {"tr": "STABLECOIN ARZI", "en": "STABLECOIN SUPPLY"},
    "card_total3": {"tr": "TOTAL3 (BTC & ETH HARİÇ)", "en": "TOTAL3 (EX BTC & ETH)"},
    "chg_weekly_short": {"tr": "hafta", "en": "w/w"},
    "chg_monthly_short": {"tr": "ay", "en": "m/m"},
